 ...
 * @title MockGold
 * @author Kinoshi Team
 * @notice Token Or simulé pour les tests et démonstrations
 * @dev Implémente un token ERC20 représentant l'or physique avec 18 décimales
...
contract MockGold is ERC20 {
    ...
    /**
     * @notice Constructeur du token MockGold
     * @dev Initialise le token avec le nom "Mock Gold" et le symbole "mGOLD"
    ...
    /**
     * @notice Crée de nouveaux tokens Or simulés
    ...
    /**
     * @notice Détruit des tokens Or simulés existants
